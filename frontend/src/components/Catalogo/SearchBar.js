    ...
    <>
        ...
        <div className="flex">
            <button id="dropdown-button" data-dropdown-toggle="dropdown" className="bg-secondaryBlue border-accentBlue flex-shrink-0 z-[5] inline-flex items-center py-2.5 px-4 text-sm font-medium text-center text-gray-900 bg-gray-100 border border-gray-300 rounded-s-lg hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700 dark:text-white dark:border-gray-600" type="button">
                <span className="text-white font-bold">Categoria</span>
            ...
            <div id="dropdown" className="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                <ul className="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdown-button">
                    <li>
                        <button type="button" className="inline-flex w-full px-4 py-2 hover:text-primaryBlue dark:hover:bg-gray-600 dark:hover:text-white">Folha A4</button>
                    </li>
                    <li>
                        <button type="button" className="inline-flex w-full px-4 py-2 hover:text-primaryBlue dark:hover:bg-gray-600 dark:hover:text-white">Cartolina</button>
                    </li>
                    <li>
                        <button type="button" className="inline-flex w-full px-4 py-2 hover:text-primaryBlue dark:hover:bg-gray-600 dark:hover:text-white">Post-it</button>
                    </li>
                    <li>
                        <button type="button" className="inline-flex w-full px-4 py-2 hover:text-primaryBlue dark:hover:bg-gray-600 dark:hover:text-white">Cadernos</button>
                    </li>
                </ul>
            </div>
            ...
            <div className="relative w-full">
                ...
                placeholder="Procurar na Planeta Papel" required />
