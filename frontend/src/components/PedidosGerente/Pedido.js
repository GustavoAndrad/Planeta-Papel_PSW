function Pedido({ data, valor, cancelled, onClick }) {
    const img_src = cancelled === false ? "/images/ok_verde.png" : "/images/cancelar_vermelho.png";

    return (
        <div 
            className="cursor-pointer w-full h-[100px] min-w-[300px] mt-5 flex flex-col justify-center pl-6 bg-white rounded-3xl border-2 border-accentBlue"
